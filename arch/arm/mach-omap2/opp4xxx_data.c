...
#define OMAP4430_VDD_MPU_OPP50_UV		1025000 // 350
#define OMAP4430_VDD_MPU_OPP100_UV		1114000 // 525
#define OMAP4430_VDD_MPU_OPPTURBO_UV		1203000 // 700
#define OMAP4430_VDD_MPU_OPPTURBOPLUS_UV	1259000 // Unofficial - 810
#define OMAP4430_VDD_MPU_OPPNITRO_UV		1347000 // 1.0
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1380000 // 1.2
#define OMAP4430_VDD_MPU_OPPNITROSBPLUS_UV	1385000 // Unofficial - 1.35
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPTURBOPLUS_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0x00, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBPLUS_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0x00, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPTURBOPLUS_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSBPLUS_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
};
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP2 - OPP100 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 525000000, OMAP4430_VDD_MPU_OPP100_UV),
	/* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 700000000, OMAP4430_VDD_MPU_OPPTURBO_UV),
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 810000000, OMAP4430_VDD_MPU_OPPTURBOPLUS_UV),
	/* MPU OPP4 - OPP-NT */
	...
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1350000000, OMAP4430_VDD_MPU_OPPNITROSBPLUS_UV),
	/* L3 OPP1 - OPP50 */
